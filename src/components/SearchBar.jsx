...
const SEARCH_INDEX = [
  ...
  { label: 'Case Study: University of Michigan Data Breach', keywords: ['case study', 'michigan', 'breach', 'university of michigan', 'cybersecurity'], pageIndex: 11 },
  { label: 'What is a Data Governance Framework?', keywords: ['governance framework', 'structure', 'policies', 'framework', 'system'], pageIndex: 12 },
  { label: 'Key Components of Institutional Data Governance', keywords: ['key components', 'quality management', 'standards', 'infrastructure', 'stewardship'], pageIndex: 13 },
  { label: 'Roles and Responsibilities in Data Governance', keywords: ['roles', 'responsibilities', 'data owner', 'data steward', 'leadership', 'it'], pageIndex: 14 },
  { label: 'Data Ownership and Accountability in Universities', keywords: ['ownership', 'accountability', 'responsible', 'university', 'department'], pageIndex: 15 },
  { label: 'Policy Design for Secure Data Governance', keywords: ['policy design', 'access control', 'retention', 'backup', 'classification', 'audit'], pageIndex: 16 },
  { label: 'Importance of Data Security in Accreditation', keywords: ['data security', 'security', 'breach', 'protection', 'confidentiality'], pageIndex: 17 },
  { label: 'Cybersecurity Threats in Educational Data Systems', keywords: ['cybersecurity', 'threats', 'hacking', 'phishing', 'malware', 'ransomware', 'insider'], pageIndex: 18 },
  { label: 'Role of Encryption in Protecting Institutional Data', keywords: ['encryption', 'decryption', 'at-rest', 'in-transit', 'secure', 'encoded'], pageIndex: 19 },
  { label: 'Compliance Standards for Educational Data Security', keywords: ['compliance', 'iso 27001', 'gdpr', 'it act', 'standards', 'regulations'], pageIndex: 20 },
  { label: 'Audit and Monitoring for Data Security', keywords: ['audit', 'monitoring', 'log management', 'vulnerability', 'assessment'], pageIndex: 21 },
  { label: 'Role of AI and Automation in Data Governance', keywords: ['ai', 'automation', 'artificial intelligence', 'predictive analytics', 'machine learning'], pageIndex: 22 },
  { label: 'Using Cloud Computing for Institutional Data Management', keywords: ['cloud computing', 'cloud', 'remote servers', 'backup', 'storage', 'saas'], pageIndex: 23 },
  { label: 'Database Management Systems for Accreditation Data', keywords: ['dbms', 'database', 'management system', 'sql', 'queries', 'tables'], pageIndex: 24 },
  { label: 'Blockchain for Secure Academic Records', keywords: ['blockchain', 'ledger', 'decentralized', 'immutable', 'certificates', 'tamper'], pageIndex: 25 },
  { label: 'Building a Secure Data Management System (Step-by-Step Guide)', keywords: ['step by step', 'guide', 'building', 'implementation', 'secure system'], pageIndex: 26 },
  { label: 'References & Further Reading', keywords: ['references', 'further reading', 'sources', 'bibliography', 'citations'], pageIndex: 27 },
];
